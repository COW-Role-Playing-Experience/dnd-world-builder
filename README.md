...
Already a pro? Just edit this README.md and make it your own. Want to make
it easy? [Use the template at the bottom](#editing-this-readme)!
...
```bash
cd existing_repo
git remote add origin https://gitlab.ecs.vuw.ac.nz/engr302teamc/dnd-world-builder.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ecs.vuw.ac.nz/engr302teamc/dnd-world-builder/-/settings/integrations)
...
- [ ] [Analyze your code for known vulnerabilities with Static Application
  Security Testing(SAST)](https://docs.gitlab.com/ee/user/application_security/sast/)
...
just a starting point!). Thank you
